...
--
-- Name: elements_properties; Type: TABLE; Schema: public; Owner: freecodecamp
--

CREATE TABLE public.elements_properties (
    elements_atomic_number integer,
...
ALTER TABLE public.elements_properties OWNER TO freecodecamp;
...
--
-- Data for Name: elements_properties; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--

INSERT INTO public.elements_properties VALUES (4, 'Be', 'Beryllium', 4, 9.0122, 1287, 2470, 1, 'metal');
INSERT INTO public.elements_properties VALUES (3, 'Li', 'Lithium', 3, 6.94, 180.54, 1342, 1, 'metal');
INSERT INTO public.elements_properties VALUES (1, 'H', 'Hydrogen', 1, 1.008, -259.1, -252.9, 2, 'nonmetal');
INSERT INTO public.elements_properties VALUES (6, 'C', 'Carbon', 6, 12.011, 3550, 4027, 2, 'nonmetal');
INSERT INTO public.elements_properties VALUES (7, 'N', 'Nitrogen', 7, 14.007, -210.1, -195.8, 2, 'nonmetal');
INSERT INTO public.elements_properties VALUES (8, 'O', 'Oxygen', 8, 15.999, -218, -183, 2, 'nonmetal');
INSERT INTO public.elements_properties VALUES (2, 'He', 'Helium', 2, 4.0026, -272.2, -269, 2, 'nonmetal');
INSERT INTO public.elements_properties VALUES (9, 'F', 'Fluorine', 9, 18.998, -220, -188.1, 2, 'nonmetal');
INSERT INTO public.elements_properties VALUES (10, 'Ne', 'Neon', 10, 20.18, -248.6, -246.1, 2, 'nonmetal');
INSERT INTO public.elements_properties VALUES (5, 'B', 'Boron', 5, 10.81, 2075, 4000, 3, 'metalloid');
